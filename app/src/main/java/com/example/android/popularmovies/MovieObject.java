...
public class MovieObject {
    ...
    public void setMovie_adult(String new_value) {
    ...
    public void setMovie_popularity(String new_value) {
        movie_popularity = new_value;
    }

    public void setMovie_vote_count(String new_value){
        movie_vote_count = new_value;
    }

    public void setMovie_video(String new_value) {
        movie_video = new_value;
    }

    public void setMovie_vote_average(String new_value) {
